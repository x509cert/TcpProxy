...
pub async fn read_naughty_words(file_paths: Vec<&'static str>) -> io::Result<Vec<String>> {
    ...
    tokio::spawn(async move {
        for path in file_paths_clone {
            ...
            // Split the contents into lines, filter out lines starting with '#', and collect the rest
            let filtered_contents: Vec<String> = contents.lines()
            ...
            state.contents.push(filtered_string);
        }
